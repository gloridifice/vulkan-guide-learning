...
namespace vkinit {
    ...
    VkShaderModuleCreateInfo shader_module_create_info(size_t codeSize, uint32_t *codeData);

    VkCommandBufferBeginInfo command_buffer_begin_info(VkCommandBufferUsageFlags flags);

    VkRenderPassBeginInfo
    render_pass_begin_info(VkRenderPass renderPass, VkExtent2D extent2D, VkFramebuffer framebuffer,
