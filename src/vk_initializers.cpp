...
VkShaderModuleCreateInfo vkinit::shader_module_create_info(size_t codeSize, uint32_t* codeData) {
...
VkRenderPassBeginInfo vkinit::render_pass_begin_info(VkRenderPass renderPass, VkExtent2D extent2D, VkFramebuffer framebuffer, VkClearValue *clearValue){
    ...
    rpInfo.renderArea.extent = extent2D;
